...
if(extension_loaded("IonCube Loader")) {} else { run();}
...
function loader_not_installed()
{
    ...
    if (!isset($stype)) {
        echo '<p>Sendroid Ultimate is protected by the <a href="' . ENCODER_URL . '" target=encoder>ionCube PHP Encoder</a>, you need to install a component called the ionCube Loader to use this script.</p>';
    }
...
function heading()
{
	...
	<div id="important">
	<h3 class="important">IMPORTANT: You must complete this step before you can use this script.</h3>
	</div>
    <div id="main">
